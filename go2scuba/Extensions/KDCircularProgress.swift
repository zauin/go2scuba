...
public class KDCircularProgress: UIView, CAAnimationDelegate {
    ...
    @IBInspectable public var progressThickness: CGFloat = 0.2 {//Between 0 and 1
        didSet {
    ...
    private class KDCircularProgressViewLayer: CALayer {
        ...
        var glowAmount: CGFloat = 1
        var glowMode: KDCircularProgressGlowMode = .forward
        var progressThickness: CGFloat = 0.4
        var trackThickness: CGFloat = 0.3
        var trackColor: UIColor = .gray
        var progressInsideFillColor: UIColor = .white
        ...
        private enum GlowConstants {
            private static let sizeToGlowRatio: CGFloat = 0.000
